locals {
  ...
  vpc_id  = "vpc-094821f7e4ee8fb94"
  ADM_SSOROLE_ARN = "arn:aws:iam::529088267411:role/aws-reserved/sso.amazonaws.com/us-east-2/AWSReservedSSO_ADM-RESTEST_a6086f2c5cf4dc7e"
  DS_SSOROLE_ARN = ""
  SE_SSOROLE_ARN = ""
  cross_account_arn_restest = ["arn:aws:iam::342606863765:root", "arn:aws:iam::755666072998:root", "arn:aws:iam::464457062066:root", "arn:aws:iam::088805809104:root", "arn:aws:iam::872515248080:root"]
}
...
inputs = {
    ...
    cross_account_arn = local.cross_account_arn_restest
    vpc_id = local.vpc_id
